            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                        ...
                        <input type="text" name="email" id="topbar-search" class="block p-2.5 pl-9 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search">
                        </div>
                    </form>
                    </div>
                <div class="flex items-center lg:order-2">
                    <button type="button" class="hidden justify-center items-center px-3 py-1.5 mr-2 text-xs font-medium text-white rounded-lg sm:inline-flex bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"><svg aria-hidden="true" class="mr-1 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg> New Widget</button>
                    ...
                    <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                        ...
                        <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                            ...
                            <div class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 rounded-full border border-white bg-primary-700 dark:border-gray-700">
                        ...
                        <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                            ...
                            <div class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-gray-900 rounded-full border border-white dark:border-gray-700">
                        ...
                        <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                            ...
                            <div class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-red-600 rounded-full border border-white dark:border-gray-700">
                        ...
                        <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                            ...
                            <div class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-green-400 rounded-full border border-white dark:border-gray-700">
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-purple-500 rounded-full border border-white dark:border-gray-700">
                    ...
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                        ...
                        <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                            ...
                            <li>
                                <a href="#" class="flex justify-between items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
