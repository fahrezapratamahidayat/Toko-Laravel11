            ...
            <div class="flex items-center lg:order-2">
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 rounded-full border border-white bg-primary-700 dark:border-gray-700">
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-gray-900 rounded-full border border-white dark:border-gray-700">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true"
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-red-600 rounded-full border border-white dark:border-gray-700">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                        <path
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-green-400 rounded-full border border-white dark:border-gray-700">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                        <path
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="w-11 h-11 rounded-full"
                                    ...
                                    alt="Robert image">
                                <div
                                    class="flex absolute justify-center items-center -mt-5 ml-6 w-5 h-5 bg-purple-500 rounded-full border border-white dark:border-gray-700">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true"
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                        ...
                        <li>
                            <a href="#"
                                class="flex justify-between items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
