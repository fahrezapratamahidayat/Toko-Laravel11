            ...
            <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ $product->name ?? old('name') }}" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                    ...
                    <div>
                        ...
                        <input type="text" name="brand" id="brand" value="{{ $product->brand ?? old('brand') }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" rows="4" name="description"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{{ $product->description ?? old('description') }}</textarea>
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <div class="relative flex flex-col gap-6 overflow-hidden">
                            <div
                                ...
                                <input type="file" name="image" id="image"
                                    class="absolute inset-0 h-full w-full opacity-0 group-hover:cursor-pointer">
                                <div class="flex flex-col items-center justify-center">
                                    <svg class="size-7 text-muted-foreground" xmlns="http://www.w3.org/2000/svg"="24"
                                    ...
                                    <p class="text-sm text-muted-foreground mt-2">Upload product images</p>
                                </div>
                            </div>
                        </div>
                    </div>
